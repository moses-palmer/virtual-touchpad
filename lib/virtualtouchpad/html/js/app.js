...
exports.app = (function() {
    ...
    if (checks.failures.length > 0) {
        ...
        exports.onloadCallbacks.push(features.listMissing);
        return;
    }
    ...
    module.keyboard = {
        onPress: function(keysym, symbol) {
            if (keyboard) {
                keyboard.press(keysym, symbol);
            }
        },

        onRelease: function(keysym, symbol) {
            if (keyboard) {
                keyboard.release(keysym, symbol);
            }
        }
    };
