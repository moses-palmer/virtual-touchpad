...
exports.toolbar.bottom = (function() {
    ...
    function fullscreenUpdate() {
        document.querySelector("#toolbar-bottom > .fullscreen-on"
            ).style.display =
                (document[document.FULLSCREEN_ELEMENT_NAME]
                        || checks.failed("Fullscreen"))
                    ? "none"
                    : "table-cell";
        document.querySelector("#toolbar-bottom > .fullscreen-off"
            ).style.display =
                (document[document.FULLSCREEN_ELEMENT_NAME]
                        && !checks.failed("Fullscreen"))
                    ? "table-cell"
    ...
    exports.onloadCallbacks.push(function() {
        var bottomToolbar = document.querySelectorAll("#toolbar-bottom")[0];
