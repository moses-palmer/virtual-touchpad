...
/*****************************************************************************/
/**
 * The trackbar component.
 *
 * All elements of the type `trackbar.EL` will be replaced with actual
 * trackbars.
 *
 * A trackbar Allows the user to specify a bounded numeric value.
 */
exports.trackbar = (function() {
    var module = {
        ...
        /**
         * The attribute that contains the actual value.
         */
        VALUE_ATTR: "value",

        /**
         * The attribute that contains the minimum value.
         */
        MIN_VALUE_ATTR: "min-value",

        /**
         * The attribute that contains the maximum value.
         */
        MAX_VALUE_ATTR: "max-value",

        /**
         * The attribute that contains the name of the configuration property
         * used to back this trackbar.
         *
         * Setting this will bind the value to the configuration property.
         */
        PROPERTY_ATTR: "property",

        /**
         * The attribute that contains the default value.
         *
         * This is used if no configuration property exists. It will be eval'd.
         */
        DEFAULT_VALUE_ATTR: "default-value",
    ...
    addEventListener("load", function() {
        ...
        for (var i = 0; i < els.length; i++) {
            ...
            var value = eval(el.getAttribute(module.VALUE_ATTR));
            if (isNaN(value)) {
                value = 0.0;
            }

            // Read the min and max values from the element
            var minValue = eval(el.getAttribute(module.MIN_VALUE_ATTR));
            if (isNaN(minValue)) {
                minValue = 0.0;
            }
            var maxValue = eval(el.getAttribute(module.MAX_VALUE_ATTR));
            if (isNaN(maxValue)) {
