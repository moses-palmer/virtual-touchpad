...
/*****************************************************************************/
/**
 * Performs browser checks for required features.
 *
 * Any checks that fail will be added to `checks.failures`. Some failues can be
 * worked around, while others cause the application to consider the browser not
 * to be supported.
 */
