...
exports.controller = (function() {
     ...
     *     requested, or null.
     * @param keysym
     *     The key symbol identifier. This is used only if symbol is an invalid
     *     value.
     * @param symbol
     *     The key symbol name.
     */
    Keyboard.prototype.press = function(name, keysym, symbol) {
        this.ws.send(JSON.stringify({
            command: "key.down",
            data: {
                name: name,
     ...
     *     The key symbol name.
     */
    Keyboard.prototype.release = function(name, keysym, symbol) {
        this.ws.send(JSON.stringify({
            command: "key.up",
            data: {
                name: name,
