...
exports.keyboard = (function() {
    ...
    /**
     * Returns the ID if a key.
     *
     * @param key
     *     The key DOM element.
     * @return the ID
     */
    Keyboard.prototype._getID = function getID(key) {
        return key.getAttribute(module.ID_ATTR);
    };
    ...
    Keyboard.prototype._handleKey = function handleKey(key, pressed) {
        ...
        // If the geometry file does not contain the key symbol, we need to
        // look it up in the layout
        if (!symbol) {
